...
import com.CollectionTracker.email.EmailConfig;
import com.CollectionTracker.email.EmailService;
...
public class UserService implements UserDetailsService{
	...
	public User savedUser(String email) {
	...
	public String emailInUse(String email) {
		...
		if(userExists) {
			...
			if(!savedUser.isEnabled()) {
				...
				return "An account with this Email already exists that requires confirmation. Check your email";
			} else {
	...
	//Used to build the email to be sent as a confirmation of registration
